...
import { getPortfoliosByStudentId, savePortfolio, deletePortfolio, getFeedback, addFeedback } from '../../utils/storage';
...
const StudentDashboard = ({ user, onLogout }) => {
  ...
  const handleDelete = (portfolio) => {
    if (window.confirm(`Are you sure you want to delete "${portfolio.title}"? This action cannot be undone.`)) {
              ...
              <div className="modal-body">
                <div className="project-details">
                  ...
                  <div className="portfolio-actions">
                    <button 
                      onClick={() => handleDelete(selectedPortfolio)}
